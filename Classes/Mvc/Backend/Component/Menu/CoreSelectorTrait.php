...
use ApacheSolrForTypo3\Solr\Mvc\Backend\Component\Exception\InvalidComponentCombinationException;
...
trait CoreSelectorTrait
{
    ...
    public function generateCoreSelectorMenuUsingPageTree(string $uriToRedirectTo = null)
    {
        ...
        $this->selectedSite = $siteRepository->getSiteByPageId((int)GeneralUtility::_GP('id'));
        $this->generateCoreSelectorMenu($this->selectedSite, $uriToRedirectTo);
    }
